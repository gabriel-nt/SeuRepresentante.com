...
@section('title')
    <title>Atualização de Localização</title>
@endsection
        ...
        <div class="col-12 mb-2">
            <center>
                <div class="about">
                    ...
                    <p>Atualiza a localização atual do representante</p>
                </div>
            </center>
                <form action="{{ route('representante.updateLocation', ['id' => $endereco->id])}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                        <div class="form-group col-sm-12 col-md-4">
                            <div class="input-container is-valid @error('CEP') is-invalid @enderror">
                                <input id="cep" name='CEP' class="input" value="{{$endereco->CEP}}" type="text" />
                        ...
                        <div class="form-group col-sm-12 col-md-8">
                            <div class="input-container is-valid @error('rua') is-invalid @enderror">
                                <input id="rua" name='rua' class="input" value="{{$endereco->rua}}" type="text"/>
                    ...
                    <div class="form-row">
                        <div class="form-group col-sm-12 col-md-12">
                            <div class="input-container is-valid @error('complemento') is-invalid @enderror">
                                <input id="complemento" name='complemento' class="input" value="{{$endereco->complemento}}"type="text"/>
                    ...
                    <div class="form-row">
                        <div class="form-group col-sm-12 col-md-6">
                            <div class="input-container is-valid @error('bairro') is-invalid @enderror">
                                <input id="bairro" name='bairro' class="input" value="{{$endereco->bairro}}" type="text"/>
                        ...
                        <div class="form-group col-sm-12 col-md-6">
                            <div class="input-container is-valid @error('cidade') is-invalid @enderror">
                                <input id="cidade" class="input" name='cidade' value="{{$endereco->cidade}}"type="text" />
                    ...
                    <div class="form-row">
                        <div class="form-group col-sm-12 col-md-6">
                            <div class="input-container is-valid @error('estado') is-invalid @enderror">
                                <input id="estado" class="input" type="text" name="estado"  value="{{$endereco->estado}}"/>
                        ...
                        <div class="form-group col-sm-12 col-md-6">
                            <div class="input-container is-valid @error('ibge') is-invalid @enderror">
                                <input id="ibge" class="input" type="text" name="ibge" value="{{$endereco->ibge}}"/>
